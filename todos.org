...
***** TODO make function to temporally combine new trained model/archives with original run, put last name as last run
***** TODO make gifs of existing models and send them over to Roland, make visualization scripts for showing progress of training

*** Model stabilization and abstraction
***** TODO use Gaussian noise addition to images and Gaussian label smoothing (non-model)
***** TODO make pipeline adaptable to image pixels or modify dimensionality of lfw-faces
