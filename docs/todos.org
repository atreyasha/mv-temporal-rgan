...
# notes: adding stacked dis-LSTM and seq-2-seq makes row-wise generators again
# removing seq-2-seq in generator seems more promising
# or trying seq-2-seq without cnn's in generator
# or perhaps revert with these characteristics back to 2d convolutions
# TODO: is the limiting factor the discriminator or generator
# can attempt to stack LSTMs here if generator is limiting factor

*** Model stabilization and abstraction
***** TODO consider removing the generator LSTM altogether, or alternatively revert to 1d string structure and add more layers + complexity
