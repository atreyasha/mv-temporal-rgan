...
# remove all string type operations in code
# change way of plotting etc
...
***** TODO use spectral normalization for convolutional layers
***** thoroughly review eth rgan model for comparison
