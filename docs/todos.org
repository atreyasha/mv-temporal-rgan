...
***** TODO find mid-way between generation quality and classification accuracy; run final model on this
...
***** changing to CIFAR might require modified descriptions and motivations
